...
const RoomForLecturer = () => {
  ...
  const { roomId, lecturerId } = values;
  ...
  const submitHandler = async (e) => {
    ...
    try {
      const responseData = await sendRequest(
        `http://localhost:8000/api/lecturer/room/${lecturerId}`,
        "PATCH",
...
export default RoomForLecturer;
