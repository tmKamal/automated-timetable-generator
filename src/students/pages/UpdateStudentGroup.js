...
const UpdateStudent = () => {
    ...
    const { academicYearSem, programme, groupNumber } = values;
    /* fetching students details */
    useEffect(() => {
        const loadedStudent = async () => {
            const fetchedStudent = await sendRequest(
                `https://timetable-generator-api.herokuapp.com/api/studentGroup/${studentId}`
            );
            setLoadedStudent(fetchedStudent.studentGroup);
        };
        loadedStudent();
    }, [sendRequest, reload]);
    ...
    const backToView = () => {
        history.push('/view-studentGroup');
    };
                                    ...
                                    <Grid item xs={12}>
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <MenuItem value={'Y1.S1'}>
                                                    Y1.S1
                                                </MenuItem>
                                                <MenuItem value={'Y1.S2'}>
                                                    Y1.S2
                                                </MenuItem>
                                                <MenuItem value={'Y2.S1'}>
                                                    Y2.S1
                                                </MenuItem>
                                                <MenuItem value={'Y2.S2'}>
                                                    Y2.S2
                                                </MenuItem>
                                                <MenuItem value={'Y3.S1'}>
                                                    Y3.S1
                                                </MenuItem>
                                                <MenuItem value={'Y3.S2'}>
                                                    Y3.S2
                                                </MenuItem>
                                                <MenuItem value={'Y4.S1'}>
                                                    Y4.S1
                                                </MenuItem>
                                                <MenuItem value={'Y4.S2'}>
                                                    Y4.S2
                                                </MenuItem>
                                            </Select>
                                        </FormControl>
