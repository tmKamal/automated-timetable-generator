...
import StudentGroupTable from './specificTable/pages/student-group-table';
                ...
                <div>
                    <MiniDrawer>
                        <Switch>
                            ...
                            <Route path='/student-timetable' exact>
                                <StudentGroupTable></StudentGroupTable>
                            </Route>
                            <Route path='/room-timetable' exact>
                                <RoomTable></RoomTable>
                            </Route>
                            <Route path='/lecturer-timetable' exact>
                                <LecturerTable></LecturerTable>
                            </Route>
                            <Route path='/full-table' exact>
                                <FullTable></FullTable>
                            </Route>
