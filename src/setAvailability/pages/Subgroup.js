  ...
  const submitHandler = async (e) => {
    ...
    try {
      const responseData = await sendRequest(
        `https://timetable-generator-api.herokuapp.com/api/student/not-available/${studentId}`,
        "PATCH",
      ...
      <main style={{ marginTop: "100px" }} className={classes.layout}>
        <Paper className={classes.paper}>
          <Typography
            ...
            align="center"
          >
            Set Not Avaialbility for Students(Subgroups)
          </Typography>
...
export default SubGroupNotAvailable;
